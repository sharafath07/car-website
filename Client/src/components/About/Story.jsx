            ...
            <section className="about-story">
                <div className="container">
                    <div className="about-story-img" data-aos="fade-right">
                        <img src="https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=700&q=80" alt="Auto Deluxe Showroom" />
                    </div>
                    <div className="about-story-text" data-aos="fade-left">
                        <h2>OUR STORY</h2>
                        <p>Auto Deluxe was established in 2014 in Malappuram,Alathoorpadi Kerala with a simple mission — to make quality
                        ...
                        <p>At Auto Deluxe, we believe in complete transparency. No hidden charges, no surprises. Just honest deals and
                            quality vehicles.</p>
